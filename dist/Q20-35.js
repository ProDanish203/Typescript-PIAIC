"use strict";
// Q.20
const items = ["Pakistan", "Switzerland", "England", "Turkey"];
// Q.21
const itemObj = {
    country: "Pakistan",
    city: "Karachi",
...
// Q.30, 31
console.log("\n");
const users = ["admin", "mudassir", "danish"];
...
// Q.32
console.log("\n");
const currentUsers = ["Danish", "Mudassir", "Faizan", "Rooma", "Zeyad"];
const newUsers = ["Wassaf", "Mudassir", "FAIZAN", "Abdulrehman", "Zain"];
...
// Q.34
console.log("\n");
const pizza = ["Mexican", "Italian", "Pepperoni"];
pizza.map(item => {
